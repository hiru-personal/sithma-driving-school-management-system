...
router.post('/', authenticate, requireVerifiedStudent, createBooking);
router.post('/free-class', authenticate, requireVerifiedStudent, bookFreeClass);
router.get('/student/:id', authenticate, requireVerifiedStudent, getStudentBookings);
...
// Additional lessons
router.post('/students/:id/additional-lessons', authenticate, requireVerifiedStudent, requestAdditionalLessons);
