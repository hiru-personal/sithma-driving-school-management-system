  ...
  try {
    ...
    const packages = await Package.insertMany([
      ...
      },
      {
        ...
        isPerLesson: true,
        bonusLessons: { bike: 0, threeWheeler: 0 },
        eligibilityCriteria: 'Must hold Light Vehicle license for 2+ years',
    ...
    const instructors = await User.insertMany([
      {
        ...
        nic: '197944556677',
        branch: 'Maharagama',
        teachingCategories: 'Both',
        mustChangePassword: false,
        createdBy: adminUser._id,
      },
      {
        name: 'Priyantha Kumara',
        username: 'instructor.priyantha',
        ...
        nic: '198211223344',
        branch: 'Maharagama',
        teachingCategories: 'Light',
        mustChangePassword: false,
        createdBy: adminUser._id,
      },
      {
        name: 'Samantha Perera',
        username: 'instructor.samantha',
      ...
      },
      {
        ...
        nic: '198633445566',
        branch: 'Werahara',
        teachingCategories: 'Heavy',
        mustChangePassword: false,
        createdBy: adminUser._id,
      },
      {
        name: 'Janaka Dissanayake',
        username: 'instructor.janaka',
